/*
 * Step 6 - Mini test (deletes 3 comments, no loop)
 *
 * WARNING: this deletes real data. It removes up to 3 comments so you can
 * watch the full flow once before running the bulk script. Deleting
 ...
 */
(async function miniTestComments() {
  ...
  console.log("%cDone: deleted 3 comments (test).", "color:lime;font-weight:bold");
})();
